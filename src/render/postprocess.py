...
def fix_image_video_tags(html) -> str:
    ...
    for img in images:
        ...
        if file_extension in video_mime_types:
            ...
            source_tag = soup.new_tag('source', src=src, type=video_mime_types[file_extension])

            # Append source to video tag
            video_tag.append(source_tag)

            # Add fallback text
            video_tag.append("This text is displayed if your browser does not support the video tag.")
